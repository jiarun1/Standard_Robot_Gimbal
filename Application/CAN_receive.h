...
typedef enum
{
	...
	CAN_TRIGGER_MOTOR_ID = 0x205,//XXX:the ID is different form standard robot
	CAN_PIT_MOTOR_ID = 0x206,
	CAN_YAW_MOTOR_ID = 0x207,//XXX:the ID is different form standard robot
    //CAN_YAW_MOTOR_ID = 0x206,
    //CAN_PIT_MOTOR_ID = 0x205,
    //CAN_TRIGGER_MOTOR_ID = 0x207,
	CAN_SHOOT_ALL_ID = 0x200,
	CAN_FRICTION_MOTOR1 = 0x201,
	CAN_FRICTION_MOTOR2 = 0x202,
...
/**
  * @brief          send control current of motor (0x201, 0x202)
  ...
  * @retval         none
  */
extern void CAN_cmd_shoot(int16_t fri1, int16_t fri2);
